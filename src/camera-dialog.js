...
export function renderCamDialog(container, { camParams, sceneCam }) {
    ...
    container.innerHTML =
        ...
        camSectionHTML('secondary_camera', 'UW Camera (Ultra Wide)', camParams.secondary_camera, 'relative to rig') +
        (camParams.secondary_camera_2
            ? camSectionHTML('secondary_camera_2', 'Tele Camera (Telescope)', camParams.secondary_camera_2, 'relative to rig')
            : '');
}
